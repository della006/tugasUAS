...
import com.note.R
import com.note.databinding.ActivityDetailNoteBinding
import com.note.databinding.BottomsheetNotesBinding
...
//        binding.toolbar.nibEdit.setOnClickListener(this)
    ...
    private fun deleteNote(note: Note) {
        ...
        Toast.makeText(this@DetailNoteActivity, "Note dihapus", Toast.LENGTH_SHORT).show()
    }

    private fun showBottomSheet() {
        val views: View =
            LayoutInflater.from(this).inflate(R.layout.bottomsheet_notes, null)

        val bindingBottom = BottomsheetNotesBinding.bind(views)
